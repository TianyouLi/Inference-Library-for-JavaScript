...
def extract_data(filename, num_images):
  ...
  with gzip.open(filename) as bytestream:
    ...
    #data = (PIXEL_DEPTH - data) / PIXEL_DEPTH
    data /= 255.0
...
def main(_):
  ...
  eval_prediction = tf.nn.softmax(model(eval_data), name='output')
  ...
  with tf.Session() as sess:
    ...
    tf.train.write_graph(output_graph_def, '../../model-zoo/tf/mnist', 'mnist.pb', False)
